...
```{r}
name <- c("Amsterdam", "Alkmaar", "Haarlem", "Leiden", "Den Haag", "Rotterdam", "Utrecht", "Almere", "Zwolle", "Groningen","Leeuwarden", "Arnhem", "Eindhoven", "Den Bosch", "Vlissingen", "Maastrict")
group <- c(1,1,1,2,2,2,6,5,9,8,4,10,7,7,3,0)
size <- c(1,15,9,13,3,2,4,7,11,6,14,8,5,10,0,12)
