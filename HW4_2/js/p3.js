// !preview r2d3 data = read.csv("https://github.com/rstudio/r2d3/blob/main/vignettes/gallery/bubbles/flare.csv"), d3_version = 4
...
r2d3.onRender(function(data, svg, width, height, options) {
  ...
  node.append("text")
    ...
    .selectAll("tspan")
    .data(function(d) { return d.class.dsplit(/(?=[A-Z][^A-Z])/g); })
    .enter().append("tspan")
      .attr("x", 0)
